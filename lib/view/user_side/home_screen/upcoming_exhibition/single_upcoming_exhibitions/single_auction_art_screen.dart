...
import '../../../../../core/models/auction_art_model.dart';
import '../../../../../core/utils/app_font_weight.dart';
import '../../../../../core/utils/responsive.dart';
import '../../../../../core/widgets/custom_text_2.dart';

class SingleAuctionArtScreen extends StatefulWidget {
  final String artUniqueID;

  SingleAuctionArtScreen({required this.artUniqueID});

  @override
  _SingleAuctionArtScreenState createState() => _SingleAuctionArtScreenState();
}

class _SingleAuctionArtScreenState extends State<SingleAuctionArtScreen> {
  ...
  late Future<AuctionArtModel> _artDetails;
  bool isClick = true;
  ...
  void initState() {
    ...
    if (widget.artUniqueID != null) {
      setState(() {
        ...
        _artDetails = ApiService().fetchArtDetailsAuction(widget.artUniqueID);
        isClick = false;
      });
              ...
              : FutureBuilder<AuctionArtModel>(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      AuctionArtModel artDetails = snapshot.data!;
                      return ListView(
                        children: [
                          Padding(
                          ...
                          artDetails.exhibitionArtImages.length == 0
                              ? SizedBox()
                              : Container(
                                  ...
                                  child: Center(
                                    child: PageView.builder(
                                      ...
                                      itemCount:
                                          artDetails.exhibitionArtImages.length,
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  (() {
                                    if (artDetails.bid_start_from != null && artDetails.bid_start_to != null &&
                                        artDetails.bid_start_from!.isNotEmpty && artDetails.bid_start_to!.isNotEmpty) {
                                      return "Starting Bid : \$${artDetails.bid_start_from} - ${artDetails.bid_start_to}";
                                    } else if (artDetails.bid_start_from != null && artDetails.bid_start_from!.isNotEmpty) {
                                      return "Starting Bid : \$${artDetails.bid_start_from}";
                                    } else if (artDetails.bid_start_to != null && artDetails.bid_start_to!.isNotEmpty) {
                                      return "Starting Bid : \$${artDetails.bid_start_to}";
                                    }
                                    return "";
                                  })(),
                                  textAlign: TextAlign.start,
                                ...
                                // Text(
                                //   textAlign: TextAlign.start,
                                //   "Staring Bid : \$${artDetails.bid_start_from} - ${artDetails.bid_start_to}",
                                //   style: GoogleFonts.poppins(
                                //     letterSpacing: 1.5,
                                //     color: textBlack,
                                //     fontSize: Responsive.getFontSize(16),
