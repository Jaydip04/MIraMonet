import 'package:artist/view/user_side/profile_screen/profile_screens/my_enquiry_replay_screen.dart';
...
class ArtEnquiryScreen extends StatefulWidget {
  const ArtEnquiryScreen({super.key});

  @override
  State<ArtEnquiryScreen> createState() => _ArtEnquiryScreenState();
}

class _ArtEnquiryScreenState extends State<ArtEnquiryScreen> {
  @override
  void initState() {
    _loadUserData();
    super.initState();
          ...
          child: ListView(
            children: [
              ...
              FutureBuilder<List<dynamic>>(
                future:
                    ApiService().fetchArtEnquiries(customerUniqueID.toString()),
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return GestureDetector(
                            onTap: () {
                              ...
                              //       art_enquiry_chat_id: enquiry['enquiry']
                              //           ['art_unique_id'],
                              //     ),
                              //   ),
                              // );
