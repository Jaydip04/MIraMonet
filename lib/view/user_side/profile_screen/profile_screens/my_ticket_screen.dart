...
class _MyTicketScreenState extends State<MyTicketScreen> {
  // final String customerUniqueId = "6073220961";
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          child: FutureBuilder<Map<String, dynamic>>(
            future: ApiService()
                .fetchExhibitionsTicket(customerUniqueID.toString()),
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView(
                  children: [
                    ...
                    exhibitions['upcoming_exhibitions'] == null
                        ? SizedBox() : SizedBox(height: Responsive.getHeight(16)),
                    exhibitions['upcoming_exhibitions'] == null
                        ? SizedBox()
                        : Container(
...
class _EventCardState extends State<EventCard> {
  ...
  Future<void> registerForExhibition(BuildContext context) async {
    ...
    final response = await apiService
        .registerTicket(widget.exhibition['registration_code'].toString());
    ...
    if (response != null) {
      ...
      if (response['status'] == 'true') {
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) =>
                ShowTicketScreen(exhibitionData: response['data']),
          ),
        );
      } else {
        setState(() {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            padding: EdgeInsets.symmetric(horizontal: Responsive.getWidth(9)),
            child: ExpandableText(text: widget.exhibition['description'],maxLines: 2,),
            // Text(
          ...
          Padding(
            padding: EdgeInsets.symmetric(horizontal: Responsive.getWidth(9)),
            child: Text(
              "Start Date : ${convertDate(widget.exhibition['start_date'])}",
              style: GoogleFonts.poppins(
                  letterSpacing: 1.5,
