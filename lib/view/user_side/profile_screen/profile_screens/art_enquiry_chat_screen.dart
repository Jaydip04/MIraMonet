...
import 'my_enquiry_replay_screen.dart';
...
class ArtEnquiryChatScreen extends StatefulWidget {
  final int index;
  const ArtEnquiryChatScreen({super.key, required this.index});

  @override
  _ChatPageState createState() => _ChatPageState();
}

class _ChatPageState extends State<ArtEnquiryChatScreen>
  ...
  void _loadUserData() async {
    ...
    _chatDataFuture =
        ApiService().getCustomerEnquiry(customerUniqueId.toString());
    setState(() {
          ...
          onTap: () {
            ...
            if (chat['art_type'].toString() == "Private") {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => MyEnquiryReplayScreen(
                    art_id: chat['art_unique_id'].toString(),
                    art_type: chat['art_type'].toString(),
                    art_name: chat['title'].toString(),
                    customerUniqueID: customerUniqueID.toString(),
                      ...
                      children: [
                        Container(
                          ...
                          child: GestureDetector(
                            ...
                            child: ClipRRect(
                              ...
                              borderRadius:
                                  BorderRadius.circular(Responsive.getWidth(40)),
                            ),
                          ),
                        ),
                        SizedBox(
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            //       textColor: Color.fromRGBO(60, 60, 60, 1)),
                            // ),
                          ],
                        ),
                      ],
