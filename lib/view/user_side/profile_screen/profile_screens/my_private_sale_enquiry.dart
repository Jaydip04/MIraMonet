...
import 'package:artist/view/user_side/profile_screen/profile_screens/order_details_screen.dart';
...
class MyPrivateSaleEnquiry extends StatefulWidget {
  ...
  @override
  State<MyPrivateSaleEnquiry> createState() => _MyPrivateSaleEnquiryState();
}

class _MyPrivateSaleEnquiryState extends State<MyPrivateSaleEnquiry> {
  ...
  void initState() {
    super.initState();
    print(widget.reciver_unique_id.toString());
    print(widget.art_enquiry_chat_id.toString());
    _replies = ApiService().fetchSinglePrivateArtReplies(
        widget.reciver_unique_id.toString(),
        widget.art_enquiry_chat_id.toString());
  }

  Future<void> _sendReply() async {
    // print(widget.customerUniqueID);
    // print(widget.art_unique_id);
    // print(messageController.text);
    try {
      var response = await ApiService().sendArtPrivateReply(
          ...
          child: ListView(
            children: [
                            ...
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (_) => OrderDetailsScreen(
                                          art_unique_id: widget.art_id,
                                        )));
                          },
                          child: Image.asset(
                            "assets/profile_image/box.png",
              ...
              if (selectedImage != null) ...[
                ...
                // Image.file(
                //   selectedImage!,
                //   height: Platform.isIOS ? Responsive.getHeight(580) : Responsive.getHeight(630),
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        _showBottomSheet(context); // Trigger image picker
                      },
                      child: Icon(
                        Icons.add,
  ...
  Widget _buildDocumentView(String filePath, String extension) {
    ...
    return Container(
      margin: EdgeInsets.symmetric(
          vertical: Responsive.getHeight(220),
        ...
        children: [
          ...
          TextButton(
            ...
            child: Text("Open File",
                style: TextStyle(
                    fontSize: Responsive.getFontSize(16), color: Colors.blue)),
          ),
        ],
      ),
    );
