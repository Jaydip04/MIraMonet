...
class ReturnOrderChatScreen extends StatefulWidget {
  ...
  @override
  State<ReturnOrderChatScreen> createState() => _ReturnOrderChatScreenState();
}

class _ReturnOrderChatScreenState extends State<ReturnOrderChatScreen> {
  ...
  void initState() {
    ...
    repliesData = ApiService().fetchSingleReturnOrderReplies(
                            ...
                            children: issueImages
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: Image.network(image.image.toString(),
                                        fit: BoxFit.contain),
                                  ),
                                ],
                              ),
