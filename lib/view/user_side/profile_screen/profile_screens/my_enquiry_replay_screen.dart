...
class MyEnquiryReplayScreen extends StatefulWidget {
  ...
  @override
  State<MyEnquiryReplayScreen> createState() => _MyEnquiryReplayScreenState();
}

class _MyEnquiryReplayScreenState extends State<MyEnquiryReplayScreen> {
  ...
  void initState() {
    ...
    _replies = ApiService().fetchSingleArtReplies(
