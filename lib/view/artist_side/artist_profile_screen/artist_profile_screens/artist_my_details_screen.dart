...
class ArtistMyDetailsScreen extends StatefulWidget {
  const ArtistMyDetailsScreen({super.key});

  @override
  State<ArtistMyDetailsScreen> createState() => _ArtistMyDetailsScreenState();
}

class _ArtistMyDetailsScreenState extends State<ArtistMyDetailsScreen> {
  ...
  bool isArtistNameEditable = true;
  ...
  void toggleEdit(String field) {
    setState(() {
      if (field == 'name') {
        ...
        isArtistNameEditable = !isArtistNameEditable;
      } else if (field == 'email') {
  ...
  void _updateControllers(CustomerData customerData) {
    setState(() {
      ...
      artistNameController.text = customerData.artistName ?? "";
      ...
      introCodeController.text = customerData.introduction ?? '';
  ...
  void _updateArtistName() async {
    ...
    await ApiService()
        .updateArtistName(
            customerUniqueID.toString(), artistNameController.text.toString())
        .then((onValue) {
      // showToast(message: "Profile Update Successfully");
      setState(() {
        isLoading3 = false;
                            ...
                            children: [
                              SizedBox(
                                ...
                                child: AppTextFormField(
                                  ...
                                  readOnly: isArtistNameEditable,
                                  suffixIcon: IconButton(
                                    icon: Icon(
                                      isArtistNameEditable
                                          ? Icons.edit_off
                                          : Icons.edit,
                                      color: Colors.grey,
                                    ),
                                    onPressed: () {
                                      toggleEdit("artistName");
                                    },
                                  ),
                                ),
                              ),
