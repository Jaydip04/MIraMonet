...
class ArtistHelpCenterScreen extends StatefulWidget {
  const ArtistHelpCenterScreen({super.key});

  @override
  State<ArtistHelpCenterScreen> createState() => _HelpCenterScreenState();
}

class _HelpCenterScreenState extends State<ArtistHelpCenterScreen> {
  ...
  Future<void> submitChatRequest() async {
    ...
    var uri =
        Uri.parse("$serverUrl/seller_help_center_chat");
    ...
    request.fields['artist_name'] = _artController.text.toString();
  ...
  //   print(_artController.text.toString());
  //   print(_selectedCategoryId.toString());
  //   print(_desController.text.toString());
  //
  //   try {
  //     setState(() {
  //       isLoading = true;
                          ...
                          GestureDetector(
                            ...
                            child: InputDecorator(
                              ...
                              child: Row(
                                ...
                                children: [
                                  WantText2(
                                    text: _selectedCategoryName ?? "Select",
                                    fontSize:
