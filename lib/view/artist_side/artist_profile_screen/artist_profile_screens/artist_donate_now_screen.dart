...
class ArtistDonateNowScreen extends StatefulWidget {
  const ArtistDonateNowScreen({super.key});

  @override
  State<ArtistDonateNowScreen> createState() => _ArtistDonateNowScreenState();
}

class _ArtistDonateNowScreenState extends State<ArtistDonateNowScreen> {
