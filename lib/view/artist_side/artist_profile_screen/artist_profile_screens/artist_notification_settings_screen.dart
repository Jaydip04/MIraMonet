...
class ArtistNotificationSettingsScreen extends StatefulWidget {
  const ArtistNotificationSettingsScreen({super.key});

  @override
  State<ArtistNotificationSettingsScreen> createState() =>
      _ArtistNotificationSettingsScreenState();
}

class _ArtistNotificationSettingsScreenState
    extends State<ArtistNotificationSettingsScreen> {
