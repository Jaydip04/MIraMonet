...
class ArtistMiraMonetTeamChatScreen extends StatefulWidget {
  final miramonet_chat_id;
  const ArtistMiraMonetTeamChatScreen({
    super.key,
    this.miramonet_chat_id,
  });

  @override
  State<ArtistMiraMonetTeamChatScreen> createState() => _MyEnquiryReplayScreenState();
}

class _MyEnquiryReplayScreenState extends State<ArtistMiraMonetTeamChatScreen> {
