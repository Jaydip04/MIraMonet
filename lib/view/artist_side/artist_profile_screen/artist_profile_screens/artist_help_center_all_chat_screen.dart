...
import '../../artist_notification/artist_notification_screen.dart';
import 'artist_help_center_chat_screen.dart';

class ArtistHelpCenterAllChatScreen extends StatefulWidget {
  const ArtistHelpCenterAllChatScreen({super.key});

  @override
  State<ArtistHelpCenterAllChatScreen> createState() =>
      _HelpCenterAllChatScreenState();
}

class _HelpCenterAllChatScreenState
    extends State<ArtistHelpCenterAllChatScreen> {
  @override
  void initState() {
    super.initState();
    _loadUserData();
  ...
  Future<void> fetchChatData() async {
    try {
      final response = await http.post(
        Uri.parse(
            '$serverUrl/get_seller_all_help_enquiry'),
                          ...
                          return GestureDetector(
                            onTap: () {
                              ...
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (_) => ArtistHelpCenterChatScreen(
                                    art_type: chat['enquiry_category_name'],
                                    art_name: chat['artist_name'],
                                    customerUniqueID: customerUniqueID,
                                    reciver_unique_id:
