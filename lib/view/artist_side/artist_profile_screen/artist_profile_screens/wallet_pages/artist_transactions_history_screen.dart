...
class ArtistTransactionsHistoryScreen extends StatefulWidget {
  const ArtistTransactionsHistoryScreen({super.key});

  @override
  State<ArtistTransactionsHistoryScreen> createState() => _ArtistTransactionsHistoryScreenState();
}

class _ArtistTransactionsHistoryScreenState extends State<ArtistTransactionsHistoryScreen> {
  ...
  void _loadUserData() async {
    ...
    futureWalletDetails = apiService.fetchWalletDetails(customerUniqueId, 'seller');
    setState(() {
                              ...
                              child: Column(
                                children: [
                                  TabBar(
                                    ...
                                    dividerColor: Color.fromRGBO(238, 239, 242, 100),
