...
class ArtistExhibitionCardScreen extends StatefulWidget {
  final Map<String, dynamic> exhibitionData;
  const ArtistExhibitionCardScreen({super.key, required this.exhibitionData});

  @override
  State<ArtistExhibitionCardScreen> createState() =>
      _ArtistExhibitionCardScreenState();
}

class _ArtistExhibitionCardScreenState
    extends State<ArtistExhibitionCardScreen> {
  ...
  void initState() {
    ...
    // colorInt = int.parse(colors, radix: 16);
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        showToast(message: "Download Ticket After Back");
        return false;
      },
      child: Scaffold(
        ...
        body: Center(
          child: ListView(
            children: [
              SizedBox(
                height: Responsive.getHeight(74),
              ),
              Column(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  WantText2(
                      text: "Thank you for registering to",
                  ...
                  WantText2(
                      text: widget.exhibitionData['exhibition']['name'],
              ...
              Center(
                child: WantText2(
                    text: "Please Bring Your I Card  Hard Copy at Exhibition",
