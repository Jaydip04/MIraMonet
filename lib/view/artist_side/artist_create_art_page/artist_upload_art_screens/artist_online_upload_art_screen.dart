...
class ArtistOnlineUploadArtScreen extends StatefulWidget {
  const ArtistOnlineUploadArtScreen({super.key});

  @override
  State<ArtistOnlineUploadArtScreen> createState() =>
      _ArtistOnlineUploadArtScreenState();
}

class _ArtistOnlineUploadArtScreenState
    extends State<ArtistOnlineUploadArtScreen> {
  ...
  Future<void> fetchPortalPercentages() async {
    try {
      final fetchedPercentages =
          await ApiService.getPortalPercentages("Online");
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  onTap: () {
                                    setState(() {
                                      _isDropdownOpen =
                                          !_isDropdownOpen; // Toggle dropdown visibility
                                    });
                                  },
                                            ...
                                            onTap: () {
                                              setState(() {
                                                ...
                                                selectedCategoryId = category
                                                    .categoryId; // Assign correct category ID
                                              ...
                                              state.didChange(category
                                                  .categoryName); // Update form field state
                                            },
                                          );
                                        },
                                      ),
                        ...
                        //             ),
                        //             errorText:
                        //                 state.errorText, // Show error message
                        //           ),
  ...
  void _fetchAndShowTerms(BuildContext context) async {
    try {
      final termsData = await ApiService().getTermsConditions("Online");
