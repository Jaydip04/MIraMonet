...
import 'artist_list_exhibition_screen.dart';
import 'artist_single_upcoming_exhibition_screen.dart';
import 'exhibition/artist_exhibition_upload_screen.dart';

class ArtistExhibitionOrAuctionScreen extends StatefulWidget {
  const ArtistExhibitionOrAuctionScreen({super.key});

  @override
  State<ArtistExhibitionOrAuctionScreen> createState() =>
      _ArtistExhibitionOrAuctionScreenState();
}

class _ArtistExhibitionOrAuctionScreenState
    extends State<ArtistExhibitionOrAuctionScreen> {
  ...
  bool isArtSubmissionClosed(String? artSubmitLastDate) {
    if (artSubmitLastDate == null || artSubmitLastDate.isEmpty) {
      return false;
    }
    final DateTime today = DateTime.now();
    final DateTime deadline = DateTime.parse(artSubmitLastDate);
          ...
          children: [
            ...
            FutureBuilder<List<Exhibition>>(
              ...
              builder: (context, snapshot) {
                ...
                // Filter exhibitions where is_booth == 0
                final exhibitions = snapshot.data!
                    .where((exhibition) => exhibition.is_booth == 0)
                    .toList();
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: WantText2(
                                        text:
                                            '${convertDate(exhibition.startDate)} - ${convertDate(exhibition.endDate)}',
                                        fontSize: Responsive.getFontSize(14),
                                        fontWeight: AppFontWeight.regular,
                                        textColor: textGray9,
                                      ),
                                ...
                                Row(
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: WantText2(
                                        text:
                                            'Last date for art submission: ${convertDate(exhibition.art_submit_last_date)}',
                                ...
                                //     ?
                                isArtSubmissionClosed(
                                        exhibition.art_submit_last_date)
                                    ? GestureDetector(
                                        child: Container(
                                          width: double.infinity,
                                    ...
                                    //   onTap: () {
                                    //   },
                                    //   label: "Art submission is now closed.",
                                    //   isBoarderRadiusLess: true,
                                    //   isSelected: false,
                                    //   buttonClick: true,
                                    // )
                                        ...
                                        onTap: () {
                                          if (exhibition.isFull == true) {
                                            ...
                                            Navigator.push(
                                                ...
                                                MaterialPageRoute(
                                                    builder: (_) =>
                                                        ArtistSingleUpcomingExhibitionScreen(
                                                          exhibition_type:
                                                              "Exhibition",
...
//                 WantText2(
//                     text:
//                     "Your artwork has been successfully submitted and is pending approval by our team.",
//                     fontSize: Responsive.getFontSize(16),
