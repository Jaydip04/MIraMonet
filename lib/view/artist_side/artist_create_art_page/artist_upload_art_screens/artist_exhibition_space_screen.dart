...
class ArtistExhibitionSpaceScreen extends StatefulWidget {
  const ArtistExhibitionSpaceScreen({super.key});

  @override
  State<ArtistExhibitionSpaceScreen> createState() =>
      _ArtistExhibitionSpaceScreenState();
}

class _ArtistExhibitionSpaceScreenState
    extends State<ArtistExhibitionSpaceScreen> {
          ...
          children: [
            ...
            FutureBuilder<List<Exhibition>>(
              ...
              builder: (context, snapshot) {
                ...
                final exhibitions = snapshot.data!
                    .where((exhibition) => exhibition.is_booth == 1)
                    .toList();
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                ExpandableText(text: exhibition.description,maxLines: 3,),
                                // Text(
                                          ...
                                          MaterialPageRoute(
                                              builder: (_) =>
                                                  ArtistSingleUpcomingExhibitionScreen(
                                                    exhibition_type: "Exhibition_Space",
