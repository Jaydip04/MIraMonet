...
import 'mookup_Image_list_screen.dart';

class ArtistUploadPictureScreenForMookup extends StatefulWidget {
  @override
  _ArtistUploadPictureScreenForMookupState createState() =>
      _ArtistUploadPictureScreenForMookupState();
}

class _ArtistUploadPictureScreenForMookupState
    extends State<ArtistUploadPictureScreenForMookup> {
  String? _imageUrl1;
        ...
        setState(() {
          ...
          if(response['status'] == true){
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => MookupImageListScreen(imageUrls: imageUrls,art_unique_id: artUniqueID.toString(),),
              ),
            );
          }
