...
class ArtistUploadPictureForExhibitionScreen extends StatefulWidget {
  final exhibitionUniqueId;
  final categoryName;
  final categoryId;
  final exhibition_type;
  const ArtistUploadPictureForExhibitionScreen(
      {super.key,
  ...
  @override
  _ArtistUploadPictureForExhibitionScreenState createState() =>
      _ArtistUploadPictureForExhibitionScreenState();
}

class _ArtistUploadPictureForExhibitionScreenState
    extends State<ArtistUploadPictureForExhibitionScreen> {
  String? _imageUrl1;
  String? _imageUrl2;
  String? _imageUrl3;
  String? _imageUrl4;
  ...
  Future<void> _pickImage(int index, String artType) async {
    ...
    if (imageFile != null) {
      try {
        final response = await ApiService().uploadImageExhibition(
                    ...
                    onTap: () {
                      if (_imageUrl1 == null) {
                        ...
                        Navigator.pushReplacement(
                            ...
                            MaterialPageRoute(
                                builder: (_) =>
                                    ArtistReviewArtForExhibitionScreen(
