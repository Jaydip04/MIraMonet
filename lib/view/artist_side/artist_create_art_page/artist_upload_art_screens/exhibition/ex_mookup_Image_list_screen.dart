...
import 'artist_review_art_for_exhibition_screen.dart';
import 'artist_upload_picture_for_exhibition_screen.dart';

class ExMookupImageListScreen extends StatefulWidget {
  ...
  @override
  State<ExMookupImageListScreen> createState() =>
      _ExMookupImageListScreenState();
}

class _ExMookupImageListScreenState extends State<ExMookupImageListScreen> {
  var artUniqueID;
    ...
    setState(() {
      if (selectedImages.contains(imageUrl)) {
        ...
        if (selectedImages.length < 3) {
          ...
          showToast(message: "You can select only up to 3 images");
          // ScaffoldMessenger.of(context).showSnackBar(
          //   SnackBar(content: Text("You can select only up to 3 images")),
          // );
        }
      }
    });
      ...
      if (response.statusCode == 200) {
        ...
        if (responseData["status"] == true) {
          ...
          Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                  builder: (_) => ArtistReviewArtForExhibitionScreen(
                    ...
                    child: GestureDetector(
                      onTap: () {
                        ...
                        if (selectedImages.length == 0) {
                          showToast(message: "Please Select Mockup Immage");
                        } else {
