...
import 'ex_artist_upload_picture_screen_for_mookup.dart';

class ArtistExhibitionUploadScreen extends StatefulWidget {
  final exhibitionUniqueId;
  final categoryName;
  final categoryId;
  final exhibition_type;
  const ArtistExhibitionUploadScreen(
      {super.key,
  ...
  @override
  State<ArtistExhibitionUploadScreen> createState() =>
      _ArtistExhibitionUploadScreenState();
}

class _ArtistExhibitionUploadScreenState
    extends State<ArtistExhibitionUploadScreen> {
  ...
  Future<void> _fetchExhibitions() async {
    ...
    try {
      List<Map<String, dynamic>> exhibitions = await apiService
          .fetchForUploadArtExhibitions(customerUniqueID.toString());
      setState(() {
  ...
  Future<void> fetchPortalPercentages() async {
    try {
      final fetchedPercentages =
          await ApiService.getPortalPercentages(widget.exhibition_type);
  ...
  void _upload() async {
    ...
    print("exhibition_unique_id : ${widget.exhibitionUniqueId.toString()}");
    print("edition : ${editionController.text.toString()}");
    print("price : ${fromPriceController.text.toString()}");
    print("since : ${sinceController.text.toString()}");
    print("category : ${widget.categoryId.toString()}");
    ...
    print("portal : ${portalController.text.toString()}");
    ...
    final payload = {
      ...
      'art_type': "Exhibition",
      'exhibition_unique_id': widget.exhibitionUniqueId.toString(),
      ...
      'portal_percentages': portalController.text.toString(),
    };

    print("Payload: $payload");

    ApiService apiService = ApiService();
    var response = await apiService.uploadArtDetailsExhibition(payload);
    ...
    if (response != null) {
      ...
      if (response['status'] == true) {
        ...
        String category_name = response['category_name'] == null
            ? ""
            : response['category_name'].toString();
        String category_id = response['category_id'] == null
            ? ""
        ...
        saveArtUniqueId(artUniqueId).then((onValue) {
          if (category_id == "1") {
            ...
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (_) => ExArtistUploadPictureScreenForMookup(
            ...
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (_) => ArtistUploadPictureForExhibitionScreen(
                      exhibition_type: widget.exhibition_type,
                          categoryId: widget.categoryId,
                          categoryName: widget.categoryName,
                          exhibitionUniqueId:
      ...
      showToast(message: "Failed to upload artwork.");
      setState(() {
        isClick = false;
      });
    }
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        //         _selectedExhibition!.isEmpty) {
                        //       return 'Please select a Exhibition';
                        //     }
                        //     return null;
                        //   },
                        ...
                        //               onChanged: (value) {
                        //                 state.didChange(
                        //                     value); // Notify FormField of value change
                        //                 setState(() {
                        //                   _selectedExhibition = value;
                        //                   _selectedExhibitionId =
                        //                       _exhibitions.firstWhere(
                        //                     (exhibition) =>
                        //                         exhibition['name'] == value,
                        //                   )['exhibition_id'];
                        //                   print(
                        //                       "_selectedExhibitionId : $_selectedExhibitionId");
                        //                 });
                        //               },
                            ...
                            Flexible(
                              child: AppTextFormField(
                                ...
                                validator: (value) {
                                  ...
                                  final regex = RegExp(
                                      r'^[0-9]+(\.[0-9]{1,2})?$'); // Allows only digits with optional decimals
                        ...
                        //             ),
                        //             errorText: state
                        //                 .errorText, // Displays the error message
                        //           ),
                        //           child: DropdownButtonHideUnderline(
                        //             child: DropdownButton<String>(
                        //               dropdownColor: white,
                        ...
                        //                 });
                        //                 print(
                        //                     "_selectedPercentage : $_selectedPercentage");
                        //                 print(
                        //                     "selectedPercentageId : $selectedPercentageId");
                        //               },
                        //               items: portalPercentages
                        //                   .map((PortalPercentage percentage) {
                        //                 return DropdownMenuItem<String>(
                        ...
                        TermsCheckbox(widget.exhibitionUniqueId.toString()),
                        SizedBox(
                          height: Responsive.getHeight(13),
                        ),
                        Align(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        "No Exhibition you can Registration",
                      ...
                      WantText2(
                          text: "Please complete the registration first",
                          fontSize: Responsive.getFontSize(16),
                          fontWeight: AppFontWeight.regular,
                        ...
                        child: GeneralButton(
                          ...
                          onTap: () {
                            Navigator.pushReplacement(
                                ...
                                MaterialPageRoute(
                                    builder: (_) =>
                                        ArtistSideBottomNavBar(index: 2)));
                          },
                          label: "Back",
...
class showTermsDialog extends StatefulWidget {
  @override
  _showTermsDialogState createState() => _showTermsDialogState();
}

class _showTermsDialogState extends State<showTermsDialog> {
  @override
  Widget build(BuildContext context) {
    Responsive.init(context);
    return Dialog(
      ...
      child: Container(
        ...
        padding: EdgeInsets.symmetric(
            ...
            vertical: Responsive.getWidth(16)),
        child: SingleChildScrollView(
          child: Column(
            children: <Widget>[
              Padding(
                padding: EdgeInsets.symmetric(vertical: Responsive.getWidth(5)),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.start,
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
