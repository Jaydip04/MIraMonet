...
class ArtistMyEnquiryReplayScreen extends StatefulWidget {
  ...
  final art_name;
  final fcmToken;
  const ArtistMyEnquiryReplayScreen(
      {super.key,
  ...
  @override
  State<ArtistMyEnquiryReplayScreen> createState() => _ArtistMyEnquiryReplayScreenState();
}

class _ArtistMyEnquiryReplayScreenState extends State<ArtistMyEnquiryReplayScreen> {
  ...
  void initState() {
    ...
    print(widget.fcmToken.toString());
    _replies = ApiService().fetchSingleArtRepliesArtist(
  ...
  Future<void> _sendReply() async {
    try {
      var response = await ApiService().sendArtReply(
            ...
            children: [
              ...
              selectedImage == null ? Container(
                ...
                height: selectedImage != null
                    ...
                    : Platform.isIOS ? Responsive.getHeight(580) : Responsive.getHeight(630),
                  ...
                  builder: (context, snapshot) {
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        bool isCustomer =
                            reply.senderUniqueId == widget.customerUniqueID;
                        return Padding(
