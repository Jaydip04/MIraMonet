...
class ArtistMyArtForHomeScreen extends StatefulWidget {
  const ArtistMyArtForHomeScreen({super.key});

  @override
  State<ArtistMyArtForHomeScreen> createState() =>
      _ArtistMyArtForHomeScreenState();
}

class _ArtistMyArtForHomeScreenState extends State<ArtistMyArtForHomeScreen> {
