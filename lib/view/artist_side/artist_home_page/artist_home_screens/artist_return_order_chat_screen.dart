...
class ArtistReturnOrderChatScreen extends StatefulWidget {
  ...
  @override
  State<ArtistReturnOrderChatScreen> createState() =>
      _ArtistReturnOrderChatScreenState();
}

class _ArtistReturnOrderChatScreenState
    extends State<ArtistReturnOrderChatScreen> {
  ...
  void initState() {
    ...
    repliesData = ApiService().fetchSingleReturnOrderRepliesSeller(
        widget.reciver_unique_id, widget.art_enquiry_chat_id);
    setState(() {
      isReturnApproved = widget.isReturnApproved;
    });
  ...
  Future<void> _sendReply() async {
    try {
      var response = await ApiService().sendReturnOrderReply(
              ...
              Row(
                ...
                children: [
                  ...
                  isReturnApproved == false
                      ? GestureDetector(
                          onTap: () {
                            showRegisterDialog(context, widget.customerUniqueID,
                                widget.art_enquiry_chat_id, widget.fcm_token);
                          },
                          child: Image.asset(
                      ...
                      : GestureDetector(
                          onTap: () {
                            showRegisterDialogStatus(
                                widget.art_id, widget.fcm_token);
                          },
                          child: Image.asset(
                            "assets/status.png",
                            width: Responsive.getWidth(24),
                  ...
                  ? Container(
                      ...
                      child: FutureBuilder<HelpEnquiryResponse>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          isReturnApproved = helpEnquiryData.isReturnApproved;

                          print(helpEnquiryData.isReturnApproved);
                          return Column(
                            children: [
  ...
  void showRegisterDialogStatus(String artUniqueId, String fcmToken) {
    showDialog(
                        ...
                        child: GestureDetector(
                          onTap: () async {
                            if (_selectedframe != null) {
                              // API Call
                              ApiService()
                                  .updateSellerStatusReturn(artUniqueId,
                                      _selectedframe.toString(), fcmToken)
                                  .then((_) {
  ...
  //                                 ApiService()
  //                                     .updateSellerStatusReturn(art_unique_id,
  ...
  void showRegisterDialog(BuildContext context, String customer_unique_id,
      String return_order_id, String FCMToken) {
    showDialog(
      barrierDismissible: false,
      context: context,
      builder: (BuildContext context) {
                                ...
                                if (_trackIdController.text.isEmpty) {
                                  ...
                                  ApiService()
                                      .addTrackingSystemReturn(
                                          ...
                                          FCMToken)
                                      .then((onValue) {
                                    repliesData = ApiService()
                                        .fetchSingleReturnOrderRepliesSeller(
                                            widget.reciver_unique_id,
                                            widget.art_enquiry_chat_id);
                                    // ApiService()
                                    //     .confirmOrder(
                                    //         customer_unique_id,
                                    //         art_unique_id,
