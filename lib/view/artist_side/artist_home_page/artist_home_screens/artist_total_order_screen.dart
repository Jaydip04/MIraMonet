...
class ArtistTotalOrderScreen extends StatefulWidget {
  final int initialTabIndex;
  const ArtistTotalOrderScreen({super.key, required this.initialTabIndex});
  @override
  State<ArtistTotalOrderScreen> createState() => _ArtistOrderScreenState();
}

class _ArtistOrderScreenState extends State<ArtistTotalOrderScreen> {
...
class _OrdersListState extends State<OrdersList> {
  ...
  Future<void> fetchTrackingStatuses() async {
    ...
    try {
      ...
      //     .get(Uri.parse('$serverUrl/tracking_status'));
                ...
                children: order.artDetails
                  ...
                  return GestureDetector(
                    onTap: () {
                      ...
                      //     "/User/Profile/OrderScreen/TrackOrderScreen");
                    },
                    child: Column(
                      children: [
                        Container(
