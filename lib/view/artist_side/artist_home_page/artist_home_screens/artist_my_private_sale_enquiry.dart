...
class ArtistMyPrivateSaleEnquiry extends StatefulWidget {
  ...
  final art_id;
  final art_name;
  const ArtistMyPrivateSaleEnquiry(
  ...
  @override
  State<ArtistMyPrivateSaleEnquiry> createState() =>
      _ArtistMyPrivateSaleEnquiryState();
}

class _ArtistMyPrivateSaleEnquiryState
    extends State<ArtistMyPrivateSaleEnquiry> {
  ...
  void initState() {
    super.initState();
    print("reciver_unique_id : ${widget.reciver_unique_id}");
    print("art_enquiry_chat_id : ${widget.art_enquiry_chat_id}");
    _replies = ApiService().fetchSinglePrivateArtRepliesArtist(
  ...
  Future<void> _sendReply() async {
    ...
    try {
      var response = await ApiService().sendArtPrivateReplyArtist(
      ...
      //   SnackBar(content: Text('Failed to send art reply. Please try again.')),
      // );
    }
  }
